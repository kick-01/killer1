...
def allGP(client, message,redis):
  ...
  if text :
    ...
    if re.search(c.sors,text):
      kb = InlineKeyboardMarkup([[InlineKeyboardButton("قناه السورس 📢", url="t.me/killer_source")],[InlineKeyboardButton("تواصل السورس 💬", url="t.me/killersourcebot")],[InlineKeyboardButton("شروحات السورس 📑", url="t.me/Killer_Source")]])
